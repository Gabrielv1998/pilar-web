...
const FetchList = () => {
  ...
  useEffect(() => {
    dispatch(appActions.setPageTitle("POKEDEX"));
    getPokemons();
  }, []);
...
<BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
          {data?data.name:'_'} 
          <Avatar sx={{ width: 110, height: 110 }} src={data?data.sprites.front_default:""}>P</Avatar>
        ...
        <AccordionDetails>        
          {data && data.stats && data.stats.map((s,index)=>(           
            <Typography>
